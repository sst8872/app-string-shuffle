...
function makeWordContent(num) {
  ...
  var tempData = myData[num - 1].value;
  tempData.forEach(function (sentence, i) {
    return console.log("".concat(i + 1, ". ").concat(sentence.en));
  });
  tempData.forEach(function (sentence, i) {
    exportContent.innerHTML += "\n                                    ".concat(i + 1, ". ").concat(sentence.en, " <span class=\"korean\" style=\"font-size: 10px\">").concat(sentence.ko, "</span><br><br>\n                                    <div \n                                        class=\"blank\" \n                                        style=\"border-bottom: 1px solid black;\n                                               color: white;\n                                               margin-left: 20px;\n                                               font-size: 8px;\n                                        \"\n                                        >\n                                        ").concat(sentence.en).concat(sentence.ko, "</div><br><br>\n                                     ");
  });
